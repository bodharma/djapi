...
class TableViewSet(viewsets.ViewSet):
    ...
    def update(self, request, pk=None):
        ...
        dynamic_model = self._get_dynamic_model(table_meta)
        with connection.schema_editor() as schema_editor:
            schema_editor.alter_db_table(dynamic_model, table_meta.name, table_meta.name)
...
class TableRowViewSet(viewsets.ViewSet):
    ...
    def create(self, request, table_id):
        ...
        try:
            ...
            serializer = DynamicTableRowSerializer(data=request.data, model=DynamicTable)
    ...
    def list(self, request, table_id):
        ...
        try:
            ...
            serializer = DynamicTableRowSerializer(queryset, many=True, model=DynamicTable)
